							...
							$("#fecha_ini")
									.change(
											function() {
												...
												//Filtrar aqui haciendo una peticion que me devuelva las citas que haya ese dia de ese medico
												//Buscar en la BD por dniMedico y por dia. Conseguir las horas y las que coincidan con horas disponibles
